...
export const metadata: Metadata = {
  title: "About Us — Tile Contractor in Framingham MA Since 2005",
  description:
  ...
  alternates: { canonical: "https://www.mastertileinstallation.com/about" },
  openGraph: {
    title: "About Master Tile Installation, Inc. | Framingham MA Since 2005",
    description:
      "Family-owned tile contractor in Framingham, MA. Over 20 years of experience in floor, bathroom, and kitchen tile installation across MetroWest.",
    url: "https://www.mastertileinstallation.com/about",
    images: [
      {
        url: "/images/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Master Tile Installation team — Framingham MA tile contractor since 2005",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "About Master Tile Installation | Framingham MA",
    description:
      "Family-owned tile contractor in Framingham, MA since 2005. Over 20 years of experience.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: "About",
      item: "https://www.mastertileinstallation.com/about",
    },
  ],
};
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="rounded-lg h-72 overflow-hidden bg-stone-100">
              <img
                ...
                alt="Master Tile Installation team at work in Framingham MA"
