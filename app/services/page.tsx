...
export const metadata: Metadata = {
  title: "Bathroom, Floor & Kitchen Tile Installation Services | Framingham MA",
  description:
    "Expert tile installation services in Framingham, MA — bathroom & shower tile, floor tile, kitchen backsplash, outdoor patio, and commercial tile. Free estimates.",
  alternates: { canonical: "https://www.mastertileinstallation.com/services" },
  openGraph: {
    title: "Tile Installation Services | Master Tile Installation — Framingham MA",
    description:
      "Bathroom tile, floor tile, kitchen backsplash, outdoor patio, and commercial tile installation across Framingham and MetroWest, MA. Free in-home estimates.",
    url: "https://www.mastertileinstallation.com/services",
    images: [
      {
        url: "/images/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Tile installation services in Framingham MA",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Tile Installation Services | Framingham MA",
    description:
      "Bathroom, floor, kitchen, outdoor, and commercial tile installation in Framingham, MA.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: "Services",
      item: "https://www.mastertileinstallation.com/services",
    },
  ],
};
